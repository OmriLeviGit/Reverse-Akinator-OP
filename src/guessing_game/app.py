...
from guessing_game.config import get_redis, test_redis_connection, get_embedding_model, LLM_PROVIDER, LLM_MODEL
...
async def lifespan(app: FastAPI):
    ...
    service = LLMService()
    service.set_model(provider=LLM_PROVIDER, model=LLM_MODEL)
